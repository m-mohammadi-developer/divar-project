...
<!--begin::Card-->
    <div class="card card-custom">
                ...
                <ul class="nav nav-tabs nav-bold nav-tabs-line nav-tabs-line-3x">
                    ...
                    <li class="nav-item mr-3">
                        <a class="nav-link active" data-toggle="tab" href="#kt_user_edit_tab_1">
                            ...
                            <span class="nav-text font-size-lg">پروفایل</span>
                        </a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="nav-item mr-3">
                        <a class="nav-link" data-toggle="tab" href="#kt_user_edit_tab_3">
                            ...
                            <span class="nav-text font-size-lg">تغییر رمز عبور</span>
                        </a>
                    </li>
                    <!--end::Item-->
        ...
        <div class="card-body px-0">
            <form action="{{ route('dashboard.users.update', ['id' => $user->id]) }}" method="post" class="form" id="kt_form">
                @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-7 my-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-9">
                                        <h6 class=" text-dark font-weight-bold mb-10">اطلاعات کاربر</h6>
                                    </div>
                                </div>
                                <!--end::Row-->
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-9">
                                        <input class="form-control form-control-lg form-control-solid" type="text" value="{{ $user->name }}" name="user_name">
                                    </div>
                                </div>
                                <!--end::گروه-->
                                ...
                                <!--begin::گروه-->
                                <div class="form-group row">
                                    <label class="col-form-label col-3 text-lg-right text-left">ایمیل</label>
                                    <div class="col-9">
                                        <div class="input-group input-group-lg input-group-solid">
                                            <div class="input-group-prepend"><span class="input-group-text"><i class="la la-at"></i></span></div>
                                            <input type="email" class="form-control form-control-lg form-control-solid" value="{{ $user->email }}" placeholder="پست الکترونیک" name="user_email">
                                        </div>
                                        <span class="form-text text-muted">پست الکترونیک به صورت عمومی نمایش داده نمی شود</span>
                                    </div>
                                </div>
                                <!--end::گروه-->
